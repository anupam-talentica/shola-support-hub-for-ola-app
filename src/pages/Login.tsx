    ...
    setTimeout(() => {
      ...
      if (isValidOTP) {
        ...
        toast({
          ...
          description: "Welcome to SHOLA Support Portal",
        });
      } else {
        toast({
          title: "Invalid OTP",
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold text-foreground">SHOLA</h1>
          <p className="text-muted-foreground">Support Hub for OLA</p>
        </div>
        ...
        <div className="text-center text-sm text-muted-foreground">
          ...
          <p className="font-medium">support@olacabs.com</p>
        </div>
      </div>
    </div>
  );
